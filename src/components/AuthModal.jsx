...
const handleLogin = async (e) => {
  ...
  if (validateForm()) {
    try {
      const userData = { fullName, email, password, confirmPassword,acceptTerms }
  ...
  return (
    <>
      ...
      {/* Modal Overlay */}
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center modal-overlay" style={{background:"rgba(0,0,0,0.5)"}}>
